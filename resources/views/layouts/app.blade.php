                                ...
                                <div class="header-action-icon-2">
                                    ...
                                    <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                        <ul>
                                            ...
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="#"><img alt="Surfside Media" src="{{ asset('assets/imgs/shop/thumbnail-2.jpg')}}"></a>
                                                </div>
                                                <div class="shopping-cart-title">
                                    ...
                                    @if (Auth::check())
                                        @if (Auth::user()->utype == 'ADM')
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li> <form action="{{ route('logout') }}" method="POST">@csrf<a href="{{ route('logout') }}" onclick="event.preventDefault(); this.closest('form').submit();">Logout</a></form></li>                                            
                                            </ul>
                                        @else
                                            <li><a href="#">{{ Auth::user()->name }}<i class="fi-rs-angle-down"></i></a>
                                            <ul class="sub-menu">
