                                    ...
                                    <div class="detail-info">
                                        ...
                                        <div class="product-detail-rating">
                                            <div class="pro-details-brand">
                                                <span> Brands: <a href="shop.html">{{ $product->category_id }}</a></span>
                                            </div>
                                                ...
                                                <div class="product-cart-wrap small hover-up">
                                                    <div class="product-img-action-wrap">
                                                        <div class="product-img product-img-zoom">
                                                            <a href="{{ route('product.detail',['slug' => $rproduct->slug]) }}" tabindex="0">
                                                    ...
                                                    <div class="product-content-wrap">
                                                        <h2><a href="{{ route('product.detail',['slug' => $rproduct->slug]) }}" tabindex="0">{{ $rproduct->name}}</a></h2>
                        ...
                        <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                            ...
                            @foreach ($newProducts as $newProduct)
                                <div class="single-post clearfix">
                                    <div class="image">
                                        <img src="{{ asset('assets/imgs/shop/thumbnail-')}}{{ $newProduct->id }}.jpg" alt="{{ $newProduct->name }}">
                                    </div>
                                    <div class="content pt-10">
                                        <h5><a href="{{ route('product.detail',['slug' => $newProduct->slug]) }}">{{ $newProduct->name }}</a></h5>
