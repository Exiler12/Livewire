                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <h5><a href="{{ route('product.detail',['slug' => $product->slug]) }}">Yidarton Women Summer Blue</a></h5> <span class="product-qty">x 2</span>
                                            </td>
                                            <td>$180.00</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <h5><a href="{{ route('product.detail',['slug' => $product->slug]) }}">LDB MOON Women Summe</a></h5> <span class="product-qty">x 1</span>
                                            </td>
                                            <td>$65.00</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><i class="ti-check-box font-small text-muted mr-10"></i>
                                                <h5><a href="{{ route('product.detail',['slug' => $product->slug]) }}">Women's Short Sleeve Loose</a></h5> <span class="product-qty">x 1</span>
                                            </td>
                                            <td>$35.00</td>
                                        </tr>
                                        <tr>
