                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="product-des product-name">
                                            <h5 class="product-name"><a href="{{ route('product.detail',['slug' => $product->slug]) }}">J.Crew Mercantile Women's Short-Sleeve</a></h5>
                                    ...
                                    <tr>
                                        ...
                                        <td class="product-des">
                                            <h5 class="product-name"><a href="{{ route('product.detail',['slug' => $product->slug]) }}">Amazon Essentials Women's Tank</a></h5>
                                    ...
                                    <tr>
                                        ...
                                        <td class="product-des">
                                            <h5 class="product-name"><a href="{{ route('product.detail',['slug' => $product->slug]) }}">Amazon Brand - Daily Ritual Women's Jersey </a></h5>
