            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 m-auto">
                        <div class="row">
                            <div class="col-lg-5">
                                <div class="login_wrap widget-taber-content p-30 background-white border-radius-10 mb-md-5 mb-lg-0 mb-sm-5 bg-white">
                                    <div class="padding_eight_all">
                                        ...
                                        <div class="text-muted text-center">None have an account? <a href="{{ route('register') }}">Register now</a></div>
                                    </div>
                                </div>
                            </div>
